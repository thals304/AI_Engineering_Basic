# -*- coding: utf-8 -*-
"""(중급) 13차시_프로젝트 5 제출코드.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1j6d7a5YZaMwAclGtreLVRa9nMNMMiAT4
...
results['RMSE'] = np.sqrt(-1 * results['score'])  # 여기서 results가 정의되지 않았다고 오류가 계속 뜸
results

## 코드시작 ##
# 미션 코드 작성 : RMSE 컬럼의 이름을 RMSLE로 바꿔보세요.

results = results.name(columns={'RMSE' : 'RMSLE'}) # '...'에 코드작성
results
...
def my_GridSearch(model, train, y, param_grid, verbose=2, n_jobs=5):
    ...
    score = np.sqrt(-1 * grid_model.cv_results_['mean_test_score']) # '...' 에 코드 작성
    ...
    # RMSLE 값 계산
    results['RMSLE'] = results['score'] # '...'에 코드작성
